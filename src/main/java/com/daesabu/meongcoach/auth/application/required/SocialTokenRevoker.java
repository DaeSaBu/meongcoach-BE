...
public interface SocialTokenRevoker {
	 ...
	 * @throws com.daesabu.meongcoach.auth.domain.exception.AppleAuthorizationCodeRequiredException Apple이 코드 없이 호출된 경우
	 * @throws com.daesabu.meongcoach.auth.domain.exception.InvalidAppleAuthorizationCodeException 제공자가 코드를 거부한 경우
	 * @throws com.daesabu.meongcoach.auth.domain.exception.SocialProviderUnavailableException 제공자와 통신할 수 없는 경우
	 */
