...
public interface SocialProfileReader {
	 ...
	 * @throws com.daesabu.meongcoach.auth.domain.exception.InvalidSocialTokenException 자격증명이 유효하지 않은 경우
	 * @throws com.daesabu.meongcoach.auth.domain.exception.SocialTokenAppMismatchException 다른 앱에서 발급된 경우
	 */
