 ...
 */
public record CurriculumListResponse(Long topicId, String topicTitle, String profileImageUrl,
	...
	public static CurriculumListResponse from(CurriculumListView view) {
		List<CurriculumResponse> curriculums = view.curriculums().stream()
				...
				.toList();
		return new CurriculumListResponse(view.topicId(), view.topicTitle(), view.profileImageUrl(), curriculums);
	}
}
