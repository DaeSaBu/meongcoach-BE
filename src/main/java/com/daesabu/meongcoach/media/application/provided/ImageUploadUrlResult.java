 ...
 * @param publicUrl        업로드 완료 후 이미지가 공개되는 URL. 이후 API 요청에 이 값을 담아 등록한다
 * @param expiresInSeconds uploadUrl의 유효 시간(초)
 */
public record ImageUploadUrlResult(String uploadUrl, String publicUrl, long expiresInSeconds) {
}
