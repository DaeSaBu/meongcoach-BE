...
class GooglePropertiesTest {
	...
	private static final String VALID_JWK_SET_URI = "https://www.googleapis.com/oauth2/v3/certs";
	private static final List<String> VALID_AUDIENCES = List.of("test-google-web-client-id");
	...
	private Set<String> violatedFields(GoogleProperties properties) {
	...
	void 모든_값이_올바르면_위반이_없다() {
		GoogleProperties properties = new GoogleProperties(VALID_ISSUER, VALID_JWK_SET_URI, VALID_AUDIENCES);
	...
	void 발급자가_비어_있으면_위반이다() {
		GoogleProperties properties = new GoogleProperties(" ", VALID_JWK_SET_URI, VALID_AUDIENCES);
	...
	void 공개_키_주소가_비어_있으면_위반이다() {
		GoogleProperties properties = new GoogleProperties(VALID_ISSUER, " ", VALID_AUDIENCES);
	...
	void aud_후보가_비어_있으면_위반이다() {
		GoogleProperties properties = new GoogleProperties(VALID_ISSUER, VALID_JWK_SET_URI, List.of());
	...
	void aud_후보에_빈_값이_섞이면_위반이다() {
		GoogleProperties properties = new GoogleProperties(VALID_ISSUER, VALID_JWK_SET_URI, List.of("client-id", " "));
