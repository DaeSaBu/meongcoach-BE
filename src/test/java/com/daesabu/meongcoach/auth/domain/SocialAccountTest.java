...
class SocialAccountTest {
	...
	@Test
	void 등록하면_제공자_정보가_담긴_계정이_생성된다() {
		SocialAccount account = SocialAccount.register(USER_ID,
				new SocialAccountRegisterCommand(SocialProvider.KAKAO, "kakao-123", new Email("test@kakao.com")));
